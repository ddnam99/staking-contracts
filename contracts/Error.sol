...
library Error {
    ...
    string public constant REWARD_PERCENT_MUST_IN_RANGE_BETWEEN_ONE_TO_HUNDRED = "Error: Reward percent must be in range [1, 100]";
    ...
    string public constant AMOUNT_MUST_GREATER_OR_EQUAL_MIN_TOKEN_STAKE = "Error: Amount must be greater or equal min token stake";
    string public constant AMOUNT_MUST_LESS_OR_EQUAL_MAX_TOKEN_STAKE = "Error: Amount must be less or equal max token stake";
